...
- Pro: $249.99/شهر ($199.99/شهر سنوي), 125,000 رصيد/شهر، 1 تيرابايت`,
  ...
  },
  {
    ...
    description: `Cline is a free helper that lives inside your code editor and writes code with you. Right now every free Cline account gets a free allowance of smart AI models - including GLM 5.3 Flash (Zhipu's newest fast coding model) and DeepSeek V4 Flash (works even with $0 balance, no bank card needed). Just install, pick a model with the FREE label, and type what you want in plain words. When your free allowance runs out, you can continue with ClinePass ($9.99/month) or pay-as-you-go.`,
    url: 'https://cline.bot',
    logoUrl: 'https://icons.duckduckgo.com/ip3/cline.bot.ico',
    category: 'api-access',
    tags: ['cline', 'free', 'coding', 'ai-agent', 'models', 'api', 'glm', 'glm-5.3-flash', 'deepseek', 'deepseek-v4-flash'],
    pricing: 'free',
    steps: [
      {
        title: 'Step 1 - Install Cline (it is just an add-on)',
        description: 'Cline is an add-on (called an extension) for your code editor. If you use VS Code: open VS Code, click the square Extensions icon on the left, type Cline, and click Install. That is all - Cline now lives inside your editor as a chat panel.',
        url: 'https://cline.bot',
      },
      {
        title: 'Step 2 - Create your free Cline account',
        description: 'Open the Cline panel and click Sign up. Register with your email - this free account is what unlocks the free models. No bank card is asked for.',
        url: 'https://cline.bot',
      },
      {
        title: 'Step 3 - Tell Cline to use its own models',
        description: 'In the Cline panel, click the small settings wheel. Find the field called API Provider (this only means: which company supplies the AI brain) and choose Cline from the list. This shows you all models Cline itself offers.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'Step 4 - Pick GLM 5.3 Flash (free)',
        description: 'In the model list, look for GLM 5.3 Flash by Zhipu - the newest fast coding model with a huge memory (1M context, meaning it can read very large projects). Free models carry a FREE label. Select it. This is your AI brain - the fast, free one.',
      },
      {
      ...
      },
      {
        ...
        description: 'Example: write "make me a simple website with a blue button" and press Enter. Cline will create the files for you and ask your permission before each change - always press Approve when you agree. Tip: the free models change from time to time and the free allowance is limited, so use it now. When it runs out, Cline will offer ClinePass ($9.99/month) or pay-as-you-go - or you can add your own key later.',
      },
    ],
    nameAr: 'Cline + GLM 5.3 Flash + DeepSeek V4 Flash',
    taglineAr: 'برمجة مجانية بالذكاء الاصطناعي داخل Cline - بدون بطاقة بنكية',
    descriptionAr: `Cline مساعد مجاني يعيش داخل محرر الأكواد ويكتب معك. حالياً كل حساب Cline مجاني يحصل على حصة مجانية من نماذج ذكية - منها GLM 5.3 Flash (أسرع نماذج Zhipu للبرمجة) وDeepSeek V4 Flash (يعمل حتى برصيد 0$ وبدون بطاقة). فقط ثبّت Cline، اختر نموذجاً عليه شارة FREE، واكتب ما تريد بكلمات عادية. عند انتهاء الحصة يمكنك المتابعة مع ClinePass (9.99$/شهر) أو الدفع حسب الاستخدام.`,
    stepsAr: [
      {
        title: 'الخطوة 1 - ثبّت Cline (هو مجرد إضافة)',
        description: 'Cline إضافة صغيرة لمحرر الأكواد. إذا كنت تستعمل VS Code: افتحه، اضغط أيقونة الإضافات المربعة على اليسار، اكتب Cline، واضغط تثبيت. انتهى - أصبح Cline لوحة محادثة داخل المحرر.',
        url: 'https://cline.bot',
      },
      {
        title: 'الخطوة 2 - أنشئ حساب Cline المجاني',
        description: 'افتح لوحة Cline واضغط تسجيل. سجّل ببريدك الإلكتروني - هذا الحساب المجاني هو ما يفتح لك النماذج المجانية. لن تُطلب منك أي بطاقة بنكية.',
        url: 'https://cline.bot',
      },
      {
        title: 'الخطوة 3 - اجعل Cline يستعمل نماذجه الخاصة',
        description: 'في لوحة Cline اضغط على عجلة الإعدادات الصغيرة. ابحث عن خانة API Provider (ومعناها فقط: من أين يأتي الذكاء الاصطناعي) واختر Cline من القائمة. ستظهر لك كل النماذج التي يقدمها Cline بنفسه.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'الخطوة 4 - اختر GLM 5.3 Flash (مجاني)',
        description: 'في قائمة النماذج ابحث عن GLM 5.3 Flash من شركة Zhipu - أحدث نموذج سريع للبرمجة بذاكرة ضخمة تقرأ مشاريع كبيرة. النماذج المجانية تحمل شارة FREE. اختره - هذا هو العقل المجاني السريع.',
      },
      {
  ...
  {
    id: 'o199',
    slug: 'sarraly-100-off-founderfare',
    name: 'Sarraly - سرعلي',
    tagline: '100% OFF first two months - AI online store builder via FounderFare',
    description:
      'Sarraly (سرعلي) is an AI-powered online store builder with full control of your store. Via FounderFare startups-for-startups program: 100% off for the first two months. Source: founderfare.com/startup/sarraly - code revealed after free sign-in. Official site: sarraly.app. Category: No-code / AI.',
    url: 'https://founderfare.com/startup/sarraly',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/e5baa533-a2b0-4555-a323-0769644ca0da.jpg',
    category: 'startup-discounts',
    tags: ['free', '100-off', 'founderfare', 'startup-discount', 'no-code', 'ai', 'ecommerce'],
    pricing: 'free',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/sarraly to see the deal terms (100% off first two months).',
        url: 'https://founderfare.com/startup/sarraly',
      },
      {
        title: 'Sign up free to reveal code',
        description: 'Create a free FounderFare account - one sign-in unlocks all codes.',
        url: 'https://founderfare.com/signup',
      },
      {
        title: 'Claim on sarraly.app',
        description: 'Apply the revealed code on the official site sarraly.app.',
  ...
  {
    id: 'o200',
    slug: 'wavlo-100-off-founderfare',
    name: 'Wavlo',
    tagline: '100% OFF - NFC business card opening full profile via FounderFare',
    description:
      'Wavlo is an NFC business card that opens your full profile in one tap. Via FounderFare: 100% off deal (paid Pro / Pro+ plans may come later). Source: founderfare.com/startup/wavlo. Official site: www.wavlo.co. Category: Dev tools / Fundraising.',
    url: 'https://founderfare.com/startup/wavlo',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/8f6dffe8-ab9b-40ff-b67a-45c0d184b4b7.png',
    category: 'startup-discounts',
    tags: ['free', '100-off', 'founderfare', 'startup-discount', 'nfc', 'networking'],
    pricing: 'free',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/wavlo to see the 100% off terms.',
        url: 'https://founderfare.com/startup/wavlo',
      },
      {
        title: 'Sign up free to reveal code',
        description: 'Create a free FounderFare account to reveal the code.',
        url: 'https://founderfare.com/signup',
      },
      {
        title: 'Claim on wavlo.co',
        description: 'Apply the code on www.wavlo.co.',
        url: 'https://www.wavlo.co',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o201',
    slug: 'khebretk-100-off-founderfare',
    name: 'Khebretk',
    tagline: '100% OFF - sell courses, digital products & consultations via FounderFare',
    description:
      'Khebretk is an all-in-one platform for experts to sell digital products, courses, and consultations through their own storefront. Via FounderFare: 100% off deal. Source: founderfare.com/startup/khebretk. Official site: khebretk.com. Category: Sales / Productivity.',
    url: 'https://founderfare.com/startup/khebretk',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/3e0db35e-a8ed-4f32-adc5-ed93ee30e92b.jpg',
    category: 'startup-discounts',
    tags: ['free', '100-off', 'founderfare', 'startup-discount', 'courses', 'ecommerce', 'creators'],
    pricing: 'free',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/khebretk to see the 100% off terms.',
        url: 'https://founderfare.com/startup/khebretk',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on khebretk.com',
        description: 'Apply the code on khebretk.com.',
        url: 'https://khebretk.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o202',
    slug: 'evntown-100-off-founderfare',
    name: 'EVNTOWN',
    tagline: '100% OFF setup + Free Boost Package (699 EGP) for 1st event via FounderFare',
    description:
      'EVNTOWN is the next-gen event tech & ticketing platform in Egypt - SaaS for organizers & smart discovery for attendees. Via FounderFare: 100% off setup + free Boost package (699 EGP value) for your 1st event. Source: founderfare.com/startup/evntown. Official site: www.evntown.com. Category: Marketing / Productivity.',
    url: 'https://founderfare.com/startup/evntown',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/69252421-d198-446f-ad52-cc54465548c1.jpg',
    category: 'startup-discounts',
    tags: ['free', '100-off', 'founderfare', 'startup-discount', 'events', 'ticketing', 'egypt'],
    pricing: 'free',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/evntown to see 100% off setup terms.',
        url: 'https://founderfare.com/startup/evntown',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on evntown.com',
        description: 'Apply the code for your first event on www.evntown.com.',
        url: 'https://www.evntown.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o203',
    slug: 'booslla-90-off-founderfare',
    name: 'Booslla',
    tagline: '90% OFF first month - local discovery & marketing via FounderFare',
    description:
      'Booslla is a local discovery and offers marketing platform. Via FounderFare: 90% off first month. Source: founderfare.com/startup/booslla. Official site: www.booslla.com. Category: Dev tools / Marketing.',
    url: 'https://founderfare.com/startup/booslla',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/4413b40f-fd90-4d78-92ad-6b183ea6be4e.jpg',
    category: 'startup-discounts',
    tags: ['90-off', 'founderfare', 'startup-discount', 'marketing', 'local'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/booslla to see 90% off terms.',
        url: 'https://founderfare.com/startup/booslla',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on booslla.com',
        description: 'Apply the code on www.booslla.com.',
        url: 'https://www.booslla.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o204',
    slug: 'oryxfy-60-off-founderfare',
    name: 'Oryxfy',
    tagline: '60% OFF first subscription - omnichannel customer conversations via FounderFare',
    description:
      'Oryxfy - manage all your customer conversations in one place, across multiple channels, with AI-powered intelligence. Via FounderFare: 60% off for first subscription. Source: founderfare.com/startup/oryxfy. Official site: oryxfy.com. Category: Sales / AI.',
    url: 'https://founderfare.com/startup/oryxfy',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/0902d8bc-0594-40ab-853f-91fcd3500144.png',
    category: 'startup-discounts',
    tags: ['60-off', 'founderfare', 'startup-discount', 'sales', 'ai', 'crm'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/oryxfy to see 60% off terms.',
        url: 'https://founderfare.com/startup/oryxfy',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on oryxfy.com',
        description: 'Apply the code on oryxfy.com.',
        url: 'https://oryxfy.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o205',
    slug: 'zagel-chat-60-off-founderfare',
    name: 'Zagel Chat',
    tagline: '60% OFF first year - WhatsApp marketing & team inbox via FounderFare',
    description:
      'Zagel Chat is a WhatsApp marketing, automation & team inbox platform. Via FounderFare: 60% off for first year. Source: founderfare.com/startup/zagel-chat. Official site: zagel.chat. Category: Marketing / Sales.',
    url: 'https://founderfare.com/startup/zagel-chat',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/7e1a9452-62cb-4e87-ba40-99fb5c892262.png',
    category: 'startup-discounts',
    tags: ['60-off', 'founderfare', 'startup-discount', 'whatsapp', 'marketing'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/zagel-chat to see 60% off terms.',
        url: 'https://founderfare.com/startup/zagel-chat',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on zagel.chat',
        description: 'Apply the code on zagel.chat.',
        url: 'https://zagel.chat',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o206',
    slug: 'heronsignal-50-off-founderfare',
    name: 'HeronSignal',
    tagline: '50% OFF first three months - agentic website monitoring via FounderFare',
    description:
      'HeronSignal is agentic website monitoring that opens the pull request with the fix. Via FounderFare: 50% off first three months. Source: founderfare.com/startup/heronsignal. Official site: heronsignal.com. Category: AI.',
    url: 'https://founderfare.com/startup/heronsignal',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/23a5dcba-25f0-41a7-b78f-8a67940cb067.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'ai', 'monitoring', 'devtools'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/heronsignal to see 50% off terms.',
        url: 'https://founderfare.com/startup/heronsignal',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on heronsignal.com',
        description: 'Apply the code on heronsignal.com.',
        url: 'https://heronsignal.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o207',
    slug: 'chatplugify-50-off-founderfare',
    name: 'Chatplugify',
    tagline: '50% OFF first three months - AI support agent via FounderFare',
    description:
      'Chatplugify is an AI support agent that learns your business and answers customers on site, WhatsApp, Instagram. Via FounderFare: 50% off first three months. Source: founderfare.com/startup/chatplugify. Official site: chatplugify.com. Category: AI / Support.',
    url: 'https://founderfare.com/startup/chatplugify',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/011debcf-b87a-48c3-8502-bd5d7ef8aa3a.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'ai', 'support', 'chatbot'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/chatplugify to see terms.',
        url: 'https://founderfare.com/startup/chatplugify',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on chatplugify.com',
        description: 'Apply the code on chatplugify.com.',
        url: 'https://chatplugify.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o208',
    slug: 'routerplex-50-off-founderfare',
    name: 'RouterPlex',
    tagline: '50% OFF - one API key for 50+ AI models via FounderFare',
    description:
      'RouterPlex offers one API key for 50+ AI models. Via FounderFare: 50% off. Source: founderfare.com/startup/routerplex. Official site: routerplex.com. Category: Dev tools / AI.',
    url: 'https://founderfare.com/startup/routerplex',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/9f2e21ea-af20-4e06-b24d-e4ad8d9e7cf8.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'ai', 'api'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/routerplex to see terms.',
        url: 'https://founderfare.com/startup/routerplex',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on routerplex.com',
        description: 'Apply the code on routerplex.com.',
  ...
  {
    id: 'o209',
    slug: 'omanda-ai-50-off-founderfare',
    name: 'Omanda AI',
    tagline: '50% OFF first 3 months - AI sales agent via FounderFare',
    description:
      'Omanda AI is an autonomous AI sales agent & commerce platform for Meta channels. Via FounderFare: 50% off first 3 months on all paid plans. Source: founderfare.com/startup/omanda-ai. Official site: omanda-ai.com. Category: AI / Sales.',
    url: 'https://founderfare.com/startup/omanda-ai',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/8c954134-e551-405c-8184-05643ee4d160.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'ai', 'sales'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/omanda-ai to see terms.',
        url: 'https://founderfare.com/startup/omanda-ai',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on omanda-ai.com',
        description: 'Apply the code on omanda-ai.com.',
        url: 'https://omanda-ai.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o210',
    slug: 'scopelock-50-off-founderfare',
    name: 'ScopeLock',
    tagline: '50% OFF till Jan 2027 - prevent scope creep via FounderFare',
    description:
      'ScopeLock prevents scope creep: define requirements, track changes, keep projects aligned. Via FounderFare: 50% off until Jan 1, 2027. Source: founderfare.com/startup/scopelock. Official site: scopelock.gt.tc. Category: Dev tools / Productivity.',
    url: 'https://founderfare.com/startup/scopelock',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/e2bb56cb-2b34-4afd-bd85-1313b48bb591.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'productivity', 'project-management'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/scopelock to see terms.',
        url: 'https://founderfare.com/startup/scopelock',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on scopelock site',
        description: 'Apply the code on scopelock.gt.tc.',
        url: 'https://scopelock.gt.tc',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o211',
    slug: 'class-a-50-off-founderfare',
    name: 'Class A',
    tagline: '50% OFF first 2 months - tutoring centers platform via FounderFare',
    description:
      'Class A is an all-in-one management platform for modern tutoring and educational centers. Via FounderFare: 50% off first 2 months. Source: founderfare.com/startup/class-a. Official site: classaapp.com. Category: Analytics / Finance.',
    url: 'https://founderfare.com/startup/class-a',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/be7bdc2f-869a-4988-8787-c33156a3b7b7.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'education', 'saas'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/class-a to see terms.',
        url: 'https://founderfare.com/startup/class-a',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on classaapp.com',
        description: 'Apply the code on classaapp.com.',
        url: 'https://classaapp.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o212',
    slug: 'penta-studio-50-off-founderfare',
    name: 'Penta Studio',
    tagline: '50% OFF first 4 clients - idea to software via FounderFare',
    description:
      'Penta Studio turns ideas into software people use. Via FounderFare: 50% off for first 4 clients. Source: founderfare.com/startup/penta-studio. Official site: pentastudio.tech. Category: Dev tools / Design.',
    url: 'https://founderfare.com/startup/penta-studio',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/761219ac-7033-4000-85ae-844a8c8f491e.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'devtools', 'agency'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/penta-studio to see terms.',
        url: 'https://founderfare.com/startup/penta-studio',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on pentastudio.tech',
        description: 'Apply the code on pentastudio.tech.',
  ...
  {
    id: 'o213',
    slug: 'orbit-50-off-founderfare',
    name: 'Orbit',
    tagline: '50% OFF 3 months for first 1000 users - go-to-market app via FounderFare',
    description:
      'Orbit is an auto go-to-market desktop application. Via FounderFare: 50% off for 3 month subscription for first 1000 users. Source: founderfare.com/startup/orbit. Official site: orbit.racore.xyz. Category: Marketing / Sales.',
    url: 'https://founderfare.com/startup/orbit',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/3eb8caea-cc32-4777-ad11-261c9e19e1b0.png',
    category: 'startup-discounts',
    tags: ['50-off', 'founderfare', 'startup-discount', 'marketing', 'sales'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/orbit to see terms.',
        url: 'https://founderfare.com/startup/orbit',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on orbit site',
        description: 'Apply the code on orbit.racore.xyz.',
        url: 'https://orbit.racore.xyz',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o214',
    slug: 'sijilak-40-off-founderfare',
    name: 'Sijilak',
    tagline: '40% OFF - order management & CRM via FounderFare',
    description:
      'Sijilak is order management and CRM for online brands, cafes and restaurants. Via FounderFare: 40% off. Source: founderfare.com/startup/sijilak. Official site: sijilak.com. Category: Sales / Finance.',
    url: 'https://founderfare.com/startup/sijilak',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/a7ce4429-e75e-401a-94b2-f3c42e4eb523.png',
    category: 'startup-discounts',
    tags: ['40-off', 'founderfare', 'startup-discount', 'crm', 'sales'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/sijilak to see terms.',
        url: 'https://founderfare.com/startup/sijilak',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on sijilak.com',
        description: 'Apply the code on sijilak.com.',
        url: 'https://sijilak.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o215',
    slug: 'leadcourse-40-off-founderfare',
    name: 'LeadCourse',
    tagline: '40% OFF early access - no-code learning platform via FounderFare',
    description:
      'LeadCourse lets you build your own learning platform in minutes - fully customizable, no coding, content protection. Via FounderFare: 40% off, early access members only. Source: founderfare.com/startup/leadcourse. Official site: leadcourse.net. Category: No-code / Productivity.',
    url: 'https://founderfare.com/startup/leadcourse',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/fc3b01b8-c4d9-41d5-bee3-8d3233f28ecd.png',
    category: 'startup-discounts',
    tags: ['40-off', 'founderfare', 'startup-discount', 'no-code', 'education'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/leadcourse to see terms.',
        url: 'https://founderfare.com/startup/leadcourse',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on leadcourse.net',
        description: 'Apply the code on leadcourse.net.',
        url: 'https://leadcourse.net',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o216',
    slug: 'nesqly-35-off-founderfare',
    name: 'Nesqly',
    tagline: '35% OFF first month - campaign links tracker via FounderFare',
    description:
      'Nesqly helps build, standardize, and track campaign links without spreadsheet chaos. Via FounderFare: 35% off first month. Source: founderfare.com/startup/nesqly. Official site: nesqly.com. Category: Marketing / Analytics.',
    url: 'https://founderfare.com/startup/nesqly',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/6e4a4a8c-6740-45af-a4de-4467ab0ddba1.png',
    category: 'startup-discounts',
    tags: ['35-off', 'founderfare', 'startup-discount', 'marketing', 'analytics'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/nesqly to see terms.',
        url: 'https://founderfare.com/startup/nesqly',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on nesqly.com',
        description: 'Apply the code on nesqly.com.',
        url: 'https://nesqly.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o217',
    slug: 'rafiqy-30-off-founderfare',
    name: 'Rafiqy',
    tagline: '30% OFF - digital wellbeing app via FounderFare',
    description:
      'Rafiqy offers better digital experience - eliminate brain rot & harmful content. Via FounderFare: 30% off. Source: founderfare.com/startup/rafiqy. Official site: rafiqyapp.com. Category: Productivity / Support.',
    url: 'https://founderfare.com/startup/rafiqy',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/4354221c-4542-43a7-9083-a55add0ba4b3.png',
    category: 'startup-discounts',
    tags: ['30-off', 'founderfare', 'startup-discount', 'productivity', 'wellbeing'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/rafiqy to see terms.',
        url: 'https://founderfare.com/startup/rafiqy',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on rafiqyapp.com',
        description: 'Apply the code on rafiqyapp.com.',
        url: 'https://rafiqyapp.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o218',
    slug: 'nabra-30-off-founderfare',
    name: 'Nabra',
    tagline: '30% OFF first 2 months - teachers SaaS via FounderFare',
    description:
      'Nabra is a SaaS platform that helps teachers streamline work, engage students, grow teaching business. Via FounderFare: 30% off first 2 months. Source: founderfare.com/startup/nabra. Official site: www.nabrahq.com. Category: No-code / AI.',
    url: 'https://founderfare.com/startup/nabra',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/300e9157-0ef0-4c4a-955c-93e18162369a.png',
    category: 'startup-discounts',
    tags: ['30-off', 'founderfare', 'startup-discount', 'education', 'saas'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/nabra to see terms.',
        url: 'https://founderfare.com/startup/nabra',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on nabrahq.com',
        description: 'Apply the code on www.nabrahq.com.',
        url: 'https://www.nabrahq.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o219',
    slug: 'nazmiq-30-off-founderfare',
    name: 'NazmIQ',
    tagline: '30% OFF first 3 months - subcontractor quotes via FounderFare',
    description:
      'NazmIQ levels subcontractor quotes into apples-for-apples decision in minutes. Via FounderFare: 30% off first three months. Source: founderfare.com/startup/nazmiq. Official site: nazmiq.com. Category: Finance / Productivity.',
    url: 'https://founderfare.com/startup/nazmiq',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/656e0755-5ed2-421c-a9c3-be2c0e250b84.jpg',
    category: 'startup-discounts',
    tags: ['30-off', 'founderfare', 'startup-discount', 'finance', 'construction'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/nazmiq to see terms.',
        url: 'https://founderfare.com/startup/nazmiq',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on nazmiq.com',
        description: 'Apply the code on nazmiq.com.',
        url: 'https://nazmiq.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o220',
    slug: 'smart-planner-ai-30-off-founderfare',
    name: 'Smart Planner AI',
    tagline: '30% OFF one-time - AI daily plans via FounderFare',
    description:
      'Smart Planner AI turns tasks, deadlines, calendar events into realistic daily plans with AI, reminders, progress tracking. Via FounderFare: 30% off one-time discount all billing periods. Source: founderfare.com/startup/smart-planner-ai. Official site: smartpln.com. Category: AI / Productivity.',
    url: 'https://founderfare.com/startup/smart-planner-ai',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/f3401428-7937-4f51-8602-836fd95ee7b4.png',
    category: 'startup-discounts',
    tags: ['30-off', 'founderfare', 'startup-discount', 'ai', 'productivity'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/smart-planner-ai to see terms.',
        url: 'https://founderfare.com/startup/smart-planner-ai',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on smartpln.com',
        description: 'Apply the code on smartpln.com.',
        url: 'https://smartpln.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o221',
    slug: 'alaris-space-26-off-founderfare',
    name: 'Alaris Space',
    tagline: '26% OFF first 5 clients - custom software via FounderFare',
    description:
      'Alaris Space provides custom software solutions including web, mobile, desktop, ERP, AI apps. Via FounderFare: 26% off limited to first 5 clients. Source: founderfare.com/startup/alaris-space. Official site: www.alaris.space. Category: Dev tools / AI.',
    url: 'https://founderfare.com/startup/alaris-space',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/34e22164-0d75-48ec-8465-184881a102ae.png',
    category: 'startup-discounts',
    tags: ['26-off', 'founderfare', 'startup-discount', 'devtools', 'agency'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/alaris-space to see terms.',
        url: 'https://founderfare.com/startup/alaris-space',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on alaris.space',
        description: 'Apply the code on www.alaris.space.',
        url: 'https://www.alaris.space',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o222',
    slug: 'q-orders-25-off-founderfare',
    name: 'Q-Orders',
    tagline: '25% OFF - restaurant ordering platform via FounderFare',
    description:
      'Q-Orders lets restaurants and cafes own website and app under own brand and take orders directly. Via FounderFare: 25% off. Source: founderfare.com/startup/q-orders. Official site: q-orders.com. Category: Sales / Marketing.',
    url: 'https://founderfare.com/startup/q-orders',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/851037a8-75ac-458a-8679-1ef0f6924218.webp',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'restaurants', 'ordering'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/q-orders to see terms.',
        url: 'https://founderfare.com/startup/q-orders',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on q-orders.com',
        description: 'Apply the code on q-orders.com.',
        url: 'https://q-orders.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o223',
    slug: 'clinchy-25-off-founderfare',
    name: 'Clinchy',
    tagline: '25% OFF first year - growth for product builders via FounderFare',
    description:
      'Clinchy: you build the product, Clinchy handles the growth. Via FounderFare: 25% off first year. Source: founderfare.com/startup/clinchy. Official site: clinchy.net. Category: AI / Marketing.',
    url: 'https://founderfare.com/startup/clinchy',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/7068987f-f9ae-4604-81c6-4fed8e18c891.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'marketing', 'growth'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/clinchy to see terms.',
        url: 'https://founderfare.com/startup/clinchy',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on clinchy.net',
        description: 'Apply the code on clinchy.net.',
        url: 'https://clinchy.net',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o224',
    slug: 'smtping-25-off-founderfare',
    name: 'SMTPing',
    tagline: '25% OFF - email verification software via FounderFare',
    description:
      'SMTPing is email verification software. Via FounderFare: 25% off. Source: founderfare.com/startup/smtping. Official site: smtping.com. Category: Marketing.',
    url: 'https://founderfare.com/startup/smtping',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/10361ce8-b32d-4732-bdc1-a6bdde603210.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'email', 'verification'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/smtping to see terms.',
        url: 'https://founderfare.com/startup/smtping',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on smtping.com',
        description: 'Apply the code on smtping.com.',
  ...
  {
    id: 'o225',
    slug: 'fekra-ai-25-off-founderfare',
    name: 'Fekra AI',
    tagline: '25% OFF - cross-platform AI app builder via FounderFare',
    description:
      'Fekra AI is a cross-platform AI app builder for iOS, Android & web. Via FounderFare: 25% off. Source: founderfare.com/startup/fekra-ai. Official site: fekra.dev. Category: AI / No-code.',
    url: 'https://founderfare.com/startup/fekra-ai',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/c442156c-3f81-4527-8294-a636d999a6e4.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'ai', 'no-code', 'app-builder'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/fekra-ai to see terms.',
        url: 'https://founderfare.com/startup/fekra-ai',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on fekra.dev',
        description: 'Apply the code on fekra.dev.',
        url: 'https://fekra.dev',
      },
    ],
    upvotes: 0,
  ...
  {
    id: 'o226',
    slug: 'dokana-25-off-founderfare',
    name: 'Dokana',
    tagline: '25% OFF 1 month - all-in-one e-commerce via FounderFare',
    description:
      'Dokana is an all-in-one e-commerce platform to create, customize, manage online store. Via FounderFare: 25% off 1 month. Source: founderfare.com/startup/dokana. Official site: dokana.cc. Category: No-code / Sales.',
    url: 'https://founderfare.com/startup/dokana',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/d056efa3-209b-4dec-bd66-ee1802f21791.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'ecommerce', 'no-code'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/dokana to see terms.',
        url: 'https://founderfare.com/startup/dokana',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on dokana.cc',
        description: 'Apply the code on dokana.cc.',
        url: 'https://dokana.cc',
      },
    ],
    upvotes: 0,
  ...
  {
    id: 'o227',
    slug: 'servd-25-off-founderfare',
    name: 'Servd',
    tagline: '25% OFF first subscription - food commerce platform via FounderFare',
    description:
      'Servd is an all-in-one food commerce platform for orders, payments, delivery, operations, growth. Via FounderFare: 25% off first subscription. Source: founderfare.com/startup/servd. Official site: getservd.me. Category: Productivity / Marketing.',
    url: 'https://founderfare.com/startup/servd',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/78432092-cd68-46fb-ae78-add332a7c519.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'food', 'commerce'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/servd to see terms.',
        url: 'https://founderfare.com/startup/servd',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on getservd.me',
        description: 'Apply the code on getservd.me.',
        url: 'https://getservd.me',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o228',
    slug: 'builderbotics-25-off-founderfare',
    name: 'builderBotics',
    tagline: '25% OFF first month - AI automation platform via FounderFare',
    description:
      'builderBotics helps automate customer interactions, content creation, ad analysis, competitor monitoring from one AI platform. Via FounderFare: 25% off first month. Source: founderfare.com/startup/builderbotics. Official site: www.builderbotics.com. Category: AI / Sales.',
    url: 'https://founderfare.com/startup/builderbotics',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/87a5b0e2-0867-4d19-9522-e5a19e9e2343.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'ai', 'automation'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/builderbotics to see terms.',
        url: 'https://founderfare.com/startup/builderbotics',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on builderbotics.com',
        description: 'Apply the code on www.builderbotics.com.',
        url: 'https://www.builderbotics.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o229',
    slug: 'securedrive-25-off-founderfare',
    name: 'SecureDrive',
    tagline: '25% OFF new customers - secure content platform via FounderFare',
    description:
      'SecureDrive is a secure platform for educators to protect, stream, control access to digital content. Via FounderFare: 25% off new customers only. Source: founderfare.com/startup/securedrive. Official site: securedrive.online. Category: Security / Infrastructure.',
    url: 'https://founderfare.com/startup/securedrive',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/620aca22-537f-491b-9c7e-219f7dcff2a6.jpg',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'security', 'education'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/securedrive to see terms.',
        url: 'https://founderfare.com/startup/securedrive',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on securedrive.online',
        description: 'Apply the code on securedrive.online.',
        url: 'https://securedrive.online',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o230',
    slug: 'nabd-id-25-off-founderfare',
    name: 'Nabd ID',
    tagline: '25% OFF first 10 members - unified digital identity via FounderFare',
    description:
      'Nabd ID is a unified digital identity connecting personal info, accounts, services in one place. Via FounderFare: 25% off first 10 members. Source: founderfare.com/startup/nabd-id. Official site: nabdid.com. Category: Infrastructure / Analytics.',
    url: 'https://founderfare.com/startup/nabd-id',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/680f50ca-c567-486e-bbf9-fef85ac80e5e.png',
    category: 'startup-discounts',
    tags: ['25-off', 'founderfare', 'startup-discount', 'identity', 'security'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/nabd-id to see terms.',
        url: 'https://founderfare.com/startup/nabd-id',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on nabdid.com',
        description: 'Apply the code on nabdid.com.',
        url: 'https://nabdid.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o231',
    slug: 'flowfy-20-off-founderfare',
    name: 'Flowfy',
    tagline: '20% OFF first three months - e-commerce attribution via FounderFare',
    description:
      'Flowfy is an e-commerce measurement and attribution platform showing which ads and channels drive sales and profit. Via FounderFare: 20% off first three months. Source: founderfare.com/startup/flowfy. Official site: tryflowfy.com. Category: AI / Analytics.',
    url: 'https://founderfare.com/startup/flowfy',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/898607ba-7a5b-457f-9ae6-31686321f104.png',
    category: 'startup-discounts',
    tags: ['20-off', 'founderfare', 'startup-discount', 'analytics', 'ecommerce'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/flowfy to see terms.',
        url: 'https://founderfare.com/startup/flowfy',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on tryflowfy.com',
        description: 'Apply the code on tryflowfy.com.',
        url: 'https://tryflowfy.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o232',
    slug: 'corteksa-20-off-founderfare',
    name: 'Corteksa',
    tagline: '20% OFF first payment - real-estate CRM via FounderFare',
    description:
      'Corteksa is a construction and real estate CRM - WhatsApp, Instagram, Facebook, TikTok in one inbox, contracts generated. Via FounderFare: 20% off first payment. Source: founderfare.com/startup/corteksa. Official site: corteksa.com. Category: Sales / AI.',
    url: 'https://founderfare.com/startup/corteksa',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/4707c056-4d9b-43af-9c21-e4b9993b2a68.png',
    category: 'startup-discounts',
    tags: ['20-off', 'founderfare', 'startup-discount', 'crm', 'real-estate'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/corteksa to see terms.',
        url: 'https://founderfare.com/startup/corteksa',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on corteksa.com',
        description: 'Apply the code on corteksa.com.',
  ...
  {
    id: 'o233',
    slug: 'nervehq-20-off-founderfare',
    name: 'NerveHQ',
    tagline: '20% OFF setup - connect company software with AI via FounderFare',
    description:
      'NerveHQ connects all company software into one place run by AI agents. Via FounderFare: 20% off on setup & configuration. Source: founderfare.com/startup/nervehq. Official site: nervehq.com. Category: Infrastructure / AI.',
    url: 'https://founderfare.com/startup/nervehq',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/274e4418-2696-46e1-b683-afabbc1473c1.jpg',
    category: 'startup-discounts',
    tags: ['20-off', 'founderfare', 'startup-discount', 'ai', 'integration'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/nervehq to see terms.',
        url: 'https://founderfare.com/startup/nervehq',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on nervehq.com',
        description: 'Apply the code on nervehq.com.',
        url: 'https://nervehq.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o234',
    slug: 'astmation-20-off-founderfare',
    name: 'Astmation',
    tagline: '20% OFF first 6 months - software development via FounderFare',
    description:
      'Astmation is a software development company. Via FounderFare: 20% off first 6 months. Source: founderfare.com/startup/astmation. Official site: astmation.com. Category: Dev tools / AI.',
    url: 'https://founderfare.com/startup/astmation',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/838f8193-c4ad-416f-a311-7d2553686ed6.png',
    category: 'startup-discounts',
    tags: ['20-off', 'founderfare', 'startup-discount', 'devtools', 'agency'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/astmation to see terms.',
        url: 'https://founderfare.com/startup/astmation',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on astmation.com',
        description: 'Apply the code on astmation.com.',
        url: 'https://astmation.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o235',
    slug: 'circlepanel-20-off-founderfare',
    name: 'CirclePanel',
    tagline: '20% OFF monthly/yearly - user interviews via FounderFare',
    description:
      'CirclePanel is a user interviews workflow in one platform. Via FounderFare: 20% off monthly / yearly plan. Source: founderfare.com/startup/circlepanel. Official site: circlepanel.com. Category: AI / Design.',
    url: 'https://founderfare.com/startup/circlepanel',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/1e230691-5182-44d5-ad3c-bc59b613ce06.png',
    category: 'startup-discounts',
    tags: ['20-off', 'founderfare', 'startup-discount', 'research', 'ux'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/circlepanel to see terms.',
        url: 'https://founderfare.com/startup/circlepanel',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on circlepanel.com',
        description: 'Apply the code on circlepanel.com.',
        url: 'https://circlepanel.com',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o236',
    slug: 'reframe-15-off-founderfare',
    name: 'Reframe',
    tagline: '15% OFF first 2 months - AI front desk via FounderFare',
    description:
      'Reframe is a 24/7 AI front desk for clinics and service businesses answering calls, handling inquiries. Via FounderFare: 15% off first 2 months. Source: founderfare.com/startup/reframe. Official site: reframe.cx. Category: AI / Support.',
    url: 'https://founderfare.com/startup/reframe',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/26b11287-ffb6-4ef4-9d3b-727e8934fb56.png',
    category: 'startup-discounts',
    tags: ['15-off', 'founderfare', 'startup-discount', 'ai', 'support'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/reframe to see terms.',
        url: 'https://founderfare.com/startup/reframe',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on reframe.cx',
        description: 'Apply the code on reframe.cx.',
        url: 'https://reframe.cx',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o237',
    slug: 'platx-12-off-founderfare',
    name: 'PlatX',
    tagline: '12% OFF first year - education platforms via FounderFare',
    description:
      'PlatX lets you create education platforms for teachers. Via FounderFare: 12% off first year. Source: founderfare.com/startup/platx. Official site: platx.net. Category: Dev tools / AI.',
    url: 'https://founderfare.com/startup/platx',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/cc226b31-9990-4248-849c-22adbea3eb23.png',
    category: 'startup-discounts',
    tags: ['12-off', 'founderfare', 'startup-discount', 'education', 'saas'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/platx to see terms.',
        url: 'https://founderfare.com/startup/platx',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on platx.net',
        description: 'Apply the code on platx.net.',
        url: 'https://platx.net',
      },
    ],
    upvotes: 0,
  ...
  {
    id: 'o238',
    slug: 'postmentor-10-off-founderfare',
    name: 'PostMentor',
    tagline: '10% OFF first 3 months - LinkedIn posts to clients via FounderFare',
    description:
      'PostMentor turns LinkedIn post drafts into client opportunities. Via FounderFare: 10% off first three months. Source: founderfare.com/startup/postmentor. Official site: postmentor.app. Category: AI / Marketing.',
    url: 'https://founderfare.com/startup/postmentor',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/cb0de820-efb4-44b4-8ead-2a9e1ae4d649.jpg',
    category: 'startup-discounts',
    tags: ['10-off', 'founderfare', 'startup-discount', 'linkedin', 'marketing'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/postmentor to see terms.',
        url: 'https://founderfare.com/startup/postmentor',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on postmentor.app',
        description: 'Apply the code on postmentor.app.',
        url: 'https://postmentor.app',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o239',
    slug: 'kaimen-10-off-founderfare',
    name: 'Kaimen',
    tagline: '10% OFF first months - corporate wellness via FounderFare',
    description:
      'Kaimen is a corporate wellness platform connecting employees with gyms, fitness, wellbeing services. Via FounderFare: 10% off first months. Source: founderfare.com/startup/kaimen. Official site: www.kaimen.app. Category: Productivity / Design.',
    url: 'https://founderfare.com/startup/kaimen',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/bc908865-80cd-4b74-86d9-28d0563ffe67.png',
    category: 'startup-discounts',
    tags: ['10-off', 'founderfare', 'startup-discount', 'wellness', 'hr'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/kaimen to see terms.',
        url: 'https://founderfare.com/startup/kaimen',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on kaimen.app',
        description: 'Apply the code on www.kaimen.app.',
        url: 'https://www.kaimen.app',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o240',
    slug: 'vulnix-25-credits-founderfare',
    name: 'Vulnix',
    tagline: '$25 OFF - autonomous pentesting agent via FounderFare',
    description:
      'Vulnix is an autonomous pentesting agent that finds, exploits, helps fix vulnerabilities. Via FounderFare: $25 off - 25 credits, first 100 users only. Source: founderfare.com/startup/vulnix. Official site: vulnix.dev. Category: Security / AI.',
    url: 'https://founderfare.com/startup/vulnix',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/1938f160-def1-46a6-b895-f3af7ffd6e01.png',
    category: 'startup-discounts',
    tags: ['credits', 'founderfare', 'startup-discount', 'security', 'pentest'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/vulnix to see terms.',
        url: 'https://founderfare.com/startup/vulnix',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on vulnix.dev',
        description: 'Apply the code on vulnix.dev.',
  ...
  {
    id: 'o241',
    slug: 'securecode-15-off-founderfare',
    name: 'SecureCode',
    tagline: '$15 OFF - 50 AI security scans via FounderFare',
    description:
      'SecureCode: let AI write your code, SecureCode secures it. Via FounderFare: $15 off - grants 50 scan credits. Source: founderfare.com/startup/securecode. Official site: www.usesecurecode.tech. Category: No-code / Security.',
    url: 'https://founderfare.com/startup/securecode',
    logoUrl: 'https://d2ws3b3h7a2nkv.cloudfront.net/uploads/bd7fed00-7ffe-4a20-afd5-4bbf3b7365bd.png',
    category: 'startup-discounts',
    tags: ['credits', 'founderfare', 'startup-discount', 'security', 'ai-code'],
    pricing: 'freemium',
    steps: [
      {
        title: 'Open FounderFare listing',
        description: 'Go to founderfare.com/startup/securecode to see terms.',
        url: 'https://founderfare.com/startup/securecode',
      },
      {
        title: 'Sign up free to reveal code',
      ...
      {
        title: 'Claim on usesecurecode.tech',
        description: 'Apply the code on www.usesecurecode.tech.',
        url: 'https://www.usesecurecode.tech',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
