...
- Pro: $249.99/شهر ($199.99/شهر سنوي), 125,000 رصيد/شهر، 1 تيرابايت`,
  ...
  {
    id: 'o198',
    slug: 'arc-prize-2026-kaggle',
    name: 'ARC Prize 2026 (Kaggle – $850k for Fluid Intelligence)',
    tagline: 'The AGI benchmark race: ARC-AGI-3, $850k prizes, deadline Oct 26',
    description: `ARC Prize 2026 on Kaggle is the flagship race toward fluid intelligence: ARC-AGI-3 tasks where your AI must reason from few examples. $850,000 across final, milestone, and paper tracks. Entry deadline October 26, final submissions November 2. Open worldwide including Morocco - runs fully on Kaggle notebooks.`,
    url: 'https://www.kaggle.com/competitions/arc-prize-2026-arc-agi-3',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'agi', 'reasoning', 'prizes', 'research'],
    pricing: 'free',
    steps: [
      {
        title: 'Accept the rules',
        description: `Join Kaggle, open the ARC Prize 2026 page, and accept the competition rules before October 26.`,
        url: 'https://www.kaggle.com/competitions/arc-prize-2026-arc-agi-3',
      },
      {
        title: 'Build in notebooks',
        description: `Solve ARC-AGI-3 grids in Kaggle notebooks - milestone prizes reward early public solutions.`,
      },
      {
        title: 'Submit by Nov 2',
        description: `Final submissions close November 2, winners announced December 4.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    updatedAt: daysAgo(0),
    endsAt: '2026-10-26',
    nameAr: 'جائزة ARC 2026 (Kaggle – 850 ألف $)',
    taglineAr: 'سباق الذكاء المرن: ARC-AGI-3 وجوائز 850 ألف $',
    descriptionAr: `جائزة ARC 2026 على Kaggle هي السباق الأبرز نحو الذكاء المرن: مهام ARC-AGI-3 حيث يستدل الذكاء من أمثلة قليلة. 850.000$ عبر المسارات. آخر التسجيل 26 أكتوبر. مفتوحة عالمياً بما فيه المغرب.`,
    stepsAr: [
      {
        title: 'اقبل القواعد',
        description: 'انضم لـ Kaggle واقبل قواعد المسابقة قبل 26 أكتوبر.',
        url: 'https://www.kaggle.com/competitions/arc-prize-2026-arc-agi-3',
      },
      {
        title: 'ابنِ في notebooks',
        description: 'حل شبكات ARC-AGI-3 - جوائز للمراحل المبكرة.',
      },
      {
        title: 'أرسل قبل 2 نونبر',
        description: 'الإرسال النهائي 2 نونبر والفائزون 4 دجنبر.',
      },
    ],
  },
  {
    id: 'o199',
    slug: 'kaggriculture-kaggle',
    name: 'Kaggriculture (Kaggle – $50k Agentic Farming Sim)',
    tagline: 'Code a farming agent, climb the sim leaderboard - $5k x10, ends Sep 23',
    description: `Kaggriculture on Kaggle: program an agent to run a virtual farm and out-trade rivals - $50,000 across the top 10 ($5,000 each). Entry deadline September 23, final submissions September 30. Great first agentic competition, highly relevant for Morocco's agritech builders.`,
    url: 'https://www.kaggle.com/competitions/kaggriculture',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'agents', 'agritech', 'simulation', 'prizes'],
    pricing: 'free',
    steps: [
      {
        title: 'Accept the rules',
        description: `Join and accept the rules before September 23.`,
        url: 'https://www.kaggle.com/competitions/kaggriculture',
      },
      {
        title: 'Code your farmer',
        description: `Program trading, planting, and expansion logic for the sim.`,
      },
      {
        title: 'Submit by Sep 30',
        description: `Final leaderboard converges mid-October; top 10 split $50k.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    updatedAt: daysAgo(0),
    endsAt: '2026-09-23',
    nameAr: 'Kaggriculture (Kaggle – محاكاة فلاحية بـ 50 ألف $)',
    taglineAr: 'برمج وكيلاً فلاحياً وتسلق الترتيب - 10 × 5000$',
    descriptionAr: `مسابقة Kaggriculture على Kaggle: برمج وكيلاً يدير مزرعة افتراضية وتفوق على المنافسين - 50.000$ للعشرة الأوائل. آخر التسجيل 23 شتنبر. مثالية لمبتكري الأغريتك المغاربة.`,
    stepsAr: [
      {
        title: 'اقبل القواعد',
        description: 'انضم واقبل القواعد قبل 23 شتنبر.',
        url: 'https://www.kaggle.com/competitions/kaggriculture',
      },
      {
        title: 'برمج مزارعك',
        description: 'منطق التجارة والزراعة والتوسع للمحاكاة.',
      },
      {
        title: 'أرسل قبل 30 شتنبر',
        description: 'الترتيب النهائي mid-October والعشرة يتقاسمون 50 ألف $.',
      },
    ],
  },
  {
    id: 'o200',
    slug: 'rsna-knee-kaggle-2026',
    name: 'RSNA Knee MRI Challenge (Kaggle – $77k Medical Imaging)',
    tagline: 'Detect knee abnormalities from MRI: $77k + RSNA Chicago spotlight',
    description: `RSNA Knee Abnormality Detection on Kaggle with the Radiological Society of North America: multimodal knee-MRI models plus a new efficiency track for lean models. $77,000 in prizes, winners invited to RSNA 2026 in Chicago. Entry deadline October 15, final October 22. Open to all researchers including Morocco.`,
    url: 'https://www.kaggle.com/competitions/rsna-knee-abnormality-detection',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'medical-imaging', 'research', 'prizes', 'radiology'],
    pricing: 'free',
    steps: [
      {
        title: 'Accept the rules',
        description: `Join and accept before October 15.`,
        url: 'https://www.kaggle.com/competitions/rsna-knee-abnormality-detection',
      },
      {
        title: 'Train your model',
        description: `Multimodal MRI abnormality detection - plus an efficiency track for lean models.`,
      },
      {
        title: 'Submit by Oct 22',
        description: `Finals October 22, winners celebrated at RSNA Chicago.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    updatedAt: daysAgo(0),
    endsAt: '2026-10-15',
    nameAr: 'تحدي RSNA للركبة بالMRI (Kaggle – 77 ألف $)',
    taglineAr: 'اكتشف تشوهات الركبة من MRI: 77 ألف $ وأضواء شيكاغو',
    descriptionAr: `تحدي RSNA لاكتشاف تشوهات الركبة على Kaggle: نماذج MRI متعددة الوسائط مع مسار للنماذج الخفيفة. 77.000$ والفائزون في مؤتمر شيكاغو. آخر التسجيل 15 أكتوبر.`,
    stepsAr: [
      {
        title: 'اقبل القواعد',
        description: 'انضم واقبل قبل 15 أكتوبر.',
        url: 'https://www.kaggle.com/competitions/rsna-knee-abnormality-detection',
      },
      {
        title: 'درّب نموذجك',
        description: 'اكتشاف تشوهات متعدد الوسائط مع مسار الكفاءة.',
      },
      {
        title: 'أرسل قبل 22 أكتوبر',
        description: 'النهائيات 22 أكتوبر والتتويج في شيكاغو.',
      },
    ],
  },
  {
    id: 'o201',
    slug: 'buildarena-hackathon-kaggle',
    name: 'BuildArena Hackathon (Kaggle – $3k Agent Builds)',
    tagline: 'ICML-paper challenge: build machines with agents - deadline Sep 12',
    description: `BuildArena on Kaggle (from an ICML 2026 paper): engineer constructions with LLM agents via MCP - $3,000 across fun categories like Agent Master Builder and Funniest Failure. Submission deadline September 12. Great low-pressure entry into agentic building.`,
    url: 'https://www.kaggle.com/competitions/build-arena-human-ai-colleberation-engineering-challenge',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'agents', 'hackathon', 'engineering', 'prizes'],
    pricing: 'free',
    steps: [
      {
        title: 'Enter before Sep 12',
        description: `Join the hackathon track (Build with Agent) before the deadline.`,
        url: 'https://www.kaggle.com/competitions/build-arena-human-ai-colleberation-engineering-challenge',
      },
      {
        title: 'Build your machine',
        description: `Generate structures through the BuildArena MCP.`,
      },
      {
        title: 'Win a category',
        description: `8 prize categories from $200 to $700, winners around Sep 19.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    updatedAt: daysAgo(0),
    endsAt: '2026-09-12',
    nameAr: 'هاكاثون BuildArena (Kaggle – 3000$)',
    taglineAr: 'تحدي بناء بالوكلاء من ورقة ICML - آخر أجل 12 شتنبر',
    descriptionAr: `تحدي BuildArena على Kaggle (من ورقة ICML 2026): هندسة إنشاءات بوكلاء LLM عبر MCP - 3000$ عبر فئات مرحة. آخر التقديم 12 شتنبر.`,
    stepsAr: [
      {
        title: 'شارك قبل 12 شتنبر',
        description: 'انضم لمسار البناء بالوكيل قبل الأجل.',
        url: 'https://www.kaggle.com/competitions/build-arena-human-ai-colleberation-engineering-challenge',
      },
      {
        title: 'ابنِ آلتك',
        description: 'ولّد الهياكل عبر BuildArena MCP.',
      },
      {
        title: 'فُز بفئة',
        description: '8 فئات من 200$ لـ 700$.',
      },
    ],
  },
  {
    id: 'o202',
    slug: 'ev-purchases-playground-s6e9',
    name: 'Predicting EV Purchases (Kaggle Playground S6E9)',
    tagline: 'Beginner-friendly monthly tabular challenge - ends Sep 30',
    description: `Kaggle Playground Series S6E9: predict electric-vehicle interest from tabular data - the ideal monthly practice ground for Moroccan students learning ML. Started September 1, final submissions September 30. Free, no prizes, pure skill building.`,
    url: 'https://www.kaggle.com/competitions/playground-series-s6e9',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'beginner', 'tabular', 'playground', 'students'],
    pricing: 'free',
    steps: [
      {
        title: 'Join the playground',
        description: `Accept the rules and download the EV dataset.`,
        url: 'https://www.kaggle.com/competitions/playground-series-s6e9',
      },
      {
        title: 'Train and iterate',
        description: `Try XGBoost, LightGBM, or sklearn baselines against the public board.`,
      },
      {
        title: 'Submit by Sep 30',
        description: `Final deadline September 30, 11:59 PM UTC.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    updatedAt: daysAgo(0),
    endsAt: '2026-09-30',
    nameAr: 'توقع شراء السيارات الكهربائية (Kaggle)',
    taglineAr: 'تحدي جدولي شهري للمبتدئين - ينتهي 30 شتنبر',
    descriptionAr: `سلسلة Kaggle Playground S6E9: توقع الإقبال على السيارات الكهربائية من بيانات جدولية - أرضية التدريب الشهرية المثالية لطلبة تعلم الآلة. 1-30 شتنبر. مجاني بدون جوائز.`,
    stepsAr: [
      {
        title: 'انضم للملعب',
        description: 'اقبل القواعد وحمّل بيانات السيارات.',
        url: 'https://www.kaggle.com/competitions/playground-series-s6e9',
      },
      {
        title: 'درّب وكرر',
        description: 'جرّب XGBoost وLightGBM أمام اللوحة العامة.',
      },
      {
        title: 'أرسل قبل 30 شتنبر',
        description: 'الأجل النهائي 30 شتنبر 11:59 مساءً.',
      },
    ],
  },
  {
    id: 'o203',
    slug: 'titanic-ml-beginners',
    name: 'Titanic – Machine Learning from Disaster (Kaggle Starter)',
    tagline: 'The classic first ML competition: predict survival, learn the workflow',
    description: `Kaggle's legendary starter competition: predict Titanic survival and learn the end-to-end ML workflow - notebooks, submissions, leaderboard. No deadline, no prizes, just the perfect first step for Moroccan students entering machine learning. 9,500+ teams have started here.`,
    url: 'https://www.kaggle.com/competitions/titanic',
    logoUrl: 'https://www.google.com/s2/favicons?domain=kaggle.com&sz=64',
    category: 'competitions',
    tags: ['kaggle', 'beginner', 'starter', 'students', 'ml'],
    pricing: 'free',
    steps: [
      {
        title: 'Open the tutorial',
        description: `Start from the Titanic page and read the starter notebooks.`,
        url: 'https://www.kaggle.com/competitions/titanic',
      },
      {
        title: 'Train your first model',
        description: `Logistic regression or random forest on passenger data.`,
      },
      {
        title: 'Submit and iterate',
        description: `Upload predictions, climb the board, try feature engineering.`,
      },
    ],
    upvotes: 0,
    bookmarks: 0,
    ...
    createdAt: daysAgo(0),
    updatedAt: daysAgo(0),
    nameAr: 'تايتانيك – أول مسابقة تعلم آلة (Kaggle)',
    taglineAr: 'المسابقة الكلاسيكية الأولى: توقع النجاة وتعلّم المنهجية',
    descriptionAr: `مسابقة البداية الأسطورية على Kaggle: توقع نجاة التايتانيك وتعلّم منهجية تعلم الآلة - notebooks وإرسال وترتيب. بدون أجل وبدون جوائز، الخطوة الأولى المثالية.`,
    stepsAr: [
      {
        title: 'افتح الدرس',
        description: 'ابدأ من صفحة المسابقة واقرأ notebooks البداية.',
        url: 'https://www.kaggle.com/competitions/titanic',
      },
      {
        title: 'درّب أول نموذج',
        description: 'انحدار لوجستي أو غابة عشوائية على بيانات الركاب.',
      },
      {
        title: 'أرسل وكرر',
        description: 'ارفع التوقعات وتسلق الترتيب وجرّب هندسة الميزات.',
      },
    ],
  },
]