...
- Pro: $249.99/شهر ($199.99/شهر سنوي), 125,000 رصيد/شهر، 1 تيرابايت`,
  ...
  },
  {
    ...
    tagline: 'FREE Replit Teams - build & deploy from browser',
    description:
      'Replit for Startups: free Replit Teams plan - build, test, deploy applications directly from the browser with cloud-native dev environments, no local setup. Early-stage software startups, global. Source: startup-perks.com/perks/replit-startup/.',
    url: 'https://replit.com/pricing',
    logoUrl: 'https://www.google.com/s2/favicons?domain=replit.com&sz=64',
    category: 'startup-discounts',
    tags: ['free', 'ide', 'devtools', 'cloud', 'startup-perks'],
    pricing: 'free',
    steps: [
      {
        title: 'Confirm eligibility',
      ...
      },
      {
        ...
        description: 'Get the Teams plan via replit.com/pricing startup route.',
        url: 'https://replit.com/pricing',
      },
      {
    ...
    taglineAr: 'خطة Teams مجاناً - ابنِ وأطلق من المتصفح',
    descriptionAr: 'يمنح Replit الشركات الناشئة خطة Teams مجاناً - ابنِ واختبر وأطلق التطبيقات من المتصفح مباشرة ببيئات سحابية دون إعداد محلي. لشركات البرمجيات المبكرة.',
    stepsAr: [
      {
        title: 'تأكد من الأهلية',
      ...
      },
      {
        ...
        description: 'احصل على خطة Teams عبر صفحة أسعار Replit.',
        url: 'https://replit.com/pricing',
      },
      {
  ...
  {
    id: 'o306',
    slug: 'crisp-bootstrapped-support-chat',
    name: 'Crisp',
    tagline: 'Bootstrapped role model - profitable support chat SaaS',
    description:
      'Crisp is a bootstrapped customer-support chat SaaS (no fundraising) - a Bootstrap Club-style exemplar: revenue-first, founder-owned, 20+ team. Study how they grew on content, integrations, and affordable pricing. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://crisp.chat/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=crisp.chat&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'saas', 'support', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore crisp.chat: chat, knowledge base, CRM in one affordable suite.',
        url: 'https://crisp.chat/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Revenue from day one, founder-owned, content + integration-led growth - no VC needed.',
      },
      {
        title: 'Apply to your startup',
        description: 'Price for margin early, ship fast, reinvest turnover like Crisp did.',
      },
    ],
    nameAr: 'Crisp',
    taglineAr: 'نموذج ممول ذاتياً - محادثة دعم SaaS مربحة',
    descriptionAr: 'Crisp شركة محادثة دعم SaaS ممولة ذاتياً دون جمع تمويل - مثال نادي البوتستراب: إيرادات أولاً وملكية المؤسسين. ادرس نموها بالمحتوى والتكاملات والأسعار المناسبة.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف crisp.chat: محادثة وقاعدة معرفة وCRM بحزمة مناسبة.',
        url: 'https://crisp.chat/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'إيرادات من اليوم الأول وملكية المؤسسين ونمو بالمحتوى والتكاملات.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'سعّر بهامش مبكراً وأطلق بسرعة وأعد استثمار الإيرادات.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o307',
    slug: 'lempire-lemlist-bootstrapped-sales',
    name: 'Lempire (lemlist)',
    tagline: 'Bootstrapped role model - sales automation, profitable',
    description:
      'Lempire (lemlist) is a bootstrapped sales-automation SaaS - multichannel outreach built profitably without VC. Bootstrap lesson: niche deeply, charge from day one, grow via community and personal branding. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.lemlist.com/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=lemlist.com&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'saas', 'sales', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore lemlist.com: personalized multichannel outreach that monetized early.',
        url: 'https://www.lemlist.com/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Own a niche, charge from day one, community + founder-brand growth engine.',
      },
      {
        title: 'Apply to your startup',
        description: 'Pick one painful niche, price confidently, build in public.',
      },
    ],
    nameAr: 'Lempire (lemlist)',
    taglineAr: 'نموذج ممول ذاتياً - أتمتة مبيعات مربحة',
    descriptionAr: 'Lempire (lemlist) شركة أتمتة مبيعات SaaS ممولة ذاتياً دون VC. الدرس: تخصص عميق وأسعار من اليوم الأول ونمو بالمجتمع والعلامة الشخصية.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف lemlist.com: تواصل متعدد القنوات مخصص حقق إيرادات مبكراً.',
        url: 'https://www.lemlist.com/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'تخصص دقيق وأسعار من اليوم الأول ونمو بالمجتمع.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'اختر مجالاً مؤلماً واحداً وسعّر بثقة وابنِ علناً.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o308',
    slug: 'lucca-bootstrapped-hr-saas',
    name: 'Lucca',
    tagline: 'Bootstrapped role model - HR SaaS at scale',
    description:
      'Lucca is a bootstrapped HR SaaS suite (leave, expenses, timesheets) grown to tens of millions in revenue without fundraising. Bootstrap lesson: boring B2B software + excellent execution compounds. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.lucca.fr/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=lucca.fr&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'saas', 'hr', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore lucca.fr: modular HR suite sold to SMBs/mid-market.',
        url: 'https://www.lucca.fr/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Unsexy B2B + retention + upsell compounds into tens of millions - no hype needed.',
      },
      {
        title: 'Apply to your startup',
        description: 'Serve SMBs profitably, expand modules, keep churn near zero.',
      },
    ],
    nameAr: 'Lucca',
    taglineAr: 'نموذج ممول ذاتياً - موارد بشرية SaaS بتوسع',
    descriptionAr: 'Lucca مجموعة موارد بشرية SaaS ممولة ذاتياً (إجازات ونفقات ودوام) نمت لعشرات الملايين دون جمع تمويل. الدرس: برمجيات B2B عادية + تنفيذ ممتاز يتراكم.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف lucca.fr: مجموعة موارد بشرية معيارية للشركات المتوسطة.',
        url: 'https://www.lucca.fr/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'B2B عادي + احتفاظ + بيع إضافي يتراكم لعشرات الملايين.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'اخدم الشركات المتوسطة بربحية ووسّع الوحدات وحافظ على churn قريباً من الصفر.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o309',
    slug: 'superprof-bootstrapped-tutoring',
    name: 'Superprof',
    tagline: 'Bootstrapped role model - global tutoring marketplace',
    description:
      'Superprof is a bootstrapped tutoring marketplace live in dozens of countries - marketplace liquidity built on SEO and supply-first growth, no VC. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.superprof.com/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=superprof.com&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'marketplace', 'education', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore superprof.com: tutor supply + student demand matched via SEO at scale.',
        url: 'https://www.superprof.com/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Supply-first marketplace + programmatic SEO = global reach without ad spend.',
      },
      {
        title: 'Apply to your startup',
        description: 'Seed supply manually, then let SEO compound demand country by country.',
      },
    ],
    nameAr: 'Superprof',
    taglineAr: 'نموذج ممول ذاتياً - سوق دروس خصوصية عالمي',
    descriptionAr: 'Superprof سوق دروس خصوصية ممول ذاتياً في عشرات البلدان - سيولة بنيت على SEO والعرض أولاً دون VC.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف superprof.com: عرض مدرسين + طلب طلاب عبر SEO بتوسع.',
        url: 'https://www.superprof.com/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'العرض أولاً + SEO برمجي = وصول عالمي دون إنفاق إعلاني.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'ازرع العرض يدوياً ثم دع SEO يضاعف الطلب بلداً ببلد.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o310',
    slug: 'partoo-bootstrapped-local-seo',
    name: 'Partoo',
    tagline: 'Bootstrapped role model - local presence SaaS',
    description:
      'Partoo is a bootstrapped local-SEO/presence SaaS (Google Business, reviews, store locator) scaled across Europe without VC. Bootstrap lesson: sell to multi-location brands with clear ROI. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.partoo.co/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=partoo.co&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'saas', 'seo', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore partoo.co: listings, reviews, and local pages for chains.',
        url: 'https://www.partoo.co/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Clear ROI for multi-location brands funds enterprise sales without VC.',
      },
      {
        title: 'Apply to your startup',
        description: 'Quantify ROI in euros, land logos, expand locations per account.',
      },
    ],
    nameAr: 'Partoo',
    taglineAr: 'نموذج ممول ذاتياً - حضور محلي SaaS',
    descriptionAr: 'Partoo شركة حضور محلي/SEO ممولة ذاتياً توسعت أوروبياً دون VC. الدرس: بِع لعلامات متعددة الفروع بعائد واضح.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف partoo.co: قوائم وتقييمات وصفحات محلية للسلاسل.',
        url: 'https://www.partoo.co/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'عائد واضح للعلامات متعددة الفروع يمول مبيعات مؤسسية.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'قِس العائد بالأرقام واكسب شعارات ووسّع الفروع لكل حساب.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o311',
    slug: 'mylittleparis-bootstrapped-media',
    name: 'MyLittleParis',
    tagline: 'Bootstrapped role model - newsletter turned commerce',
    description:
      'MyLittleParis is a bootstrapped newsletter/media brand turned e-commerce (beauty box, experiences) - audience-first monetization without fundraising. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.mylittleparis.com/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=mylittleparis.com&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'media', 'newsletter', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore mylittleparis.com: beloved newsletter converted into commerce lines.',
        url: 'https://www.mylittleparis.com/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Own an audience first; monetize with products they already want.',
      },
      {
        title: 'Apply to your startup',
        description: 'Build a newsletter/community in your niche, then launch paid offers.',
      },
    ],
    nameAr: 'MyLittleParis',
    taglineAr: 'نموذج ممول ذاتياً - نشرة تحولت لتجارة',
    descriptionAr: 'MyLittleParis علامة نشرة/إعلام ممولة ذاتياً تحولت لتجارة (جمال وتجارب) - تحقيق دخل من الجمهور أولاً دون جمع تمويل.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف mylittleparis.com: نشرة محبوبة تحولت لخطوط تجارة.',
        url: 'https://www.mylittleparis.com/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'امتلك الجمهور أولاً ثم حقق الدخل بمنتجات يريدونها.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'ابنِ نشرة/مجتمعاً في مجالك ثم أطلق عروضاً مدفوعة.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o312',
    slug: 'staycation-bootstrapped-hotels',
    name: 'Staycation',
    tagline: 'Bootstrapped role model - hotel flash sales',
    description:
      'Staycation is a bootstrapped hotel flash-sales platform (luxury stays at -70%) grown on email/app marketing without VC. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.staycation.co/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=staycation.co&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'travel', 'marketplace', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore staycation.co: curated luxury hotels, flash deals, app-first.',
        url: 'https://www.staycation.co/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Curated supply + urgency + owned email/app audience = profitable travel.',
      },
      {
        title: 'Apply to your startup',
        description: 'Curate ruthlessly, create urgency, own the customer channel.',
      },
    ],
    nameAr: 'Staycation',
    taglineAr: 'نموذج ممول ذاتياً - تخفيضات فنادق خاطفة',
    descriptionAr: 'Staycation منصة تخفيضات فنادق خاطفة ممولة ذاتياً (إقامات فاخرة -70%) نمت بالبريد والتطبيق دون VC.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف staycation.co: فنادق فاخرة مختارة وعروض خاطفة وتطبيق أولاً.',
        url: 'https://www.staycation.co/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'عرض مختار + استعجال + جمهور بريد/تطبيق مملوك = سفر مربح.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'انتقِ بقسوة واخلق الاستعجال وامتلك قناة العملاء.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
  ...
  {
    id: 'o313',
    slug: 'tiime-bootstrapped-invoicing',
    name: 'Tiime',
    tagline: 'Bootstrapped role model - free invoicing turned fintech',
    description:
      'Tiime is a bootstrapped invoicing SaaS (free billing for SMBs) expanded into fintech services - freemium wedge into financial products, no VC. Official site below. Source: licornesociety.com bootstrap list.',
    url: 'https://www.tiime.fr/',
    logoUrl: 'https://www.google.com/s2/favicons?domain=tiime.fr&sz=64',
    category: 'forstartups',
    tags: ['bootstrap', 'saas', 'fintech', 'freemium', 'role-model', 'free'],
    pricing: 'free',
    steps: [
      {
        title: 'Study the product',
        description: 'Explore tiime.fr: free invoicing wedge with paid fintech layers.',
        url: 'https://www.tiime.fr/',
      },
      {
        title: 'Copy the bootstrap lesson',
        description: 'Free wedge product acquires SMBs cheaply; monetize with financial services.',
      },
      {
        title: 'Apply to your startup',
        description: 'Give away the wedge, charge for money-adjacent value.',
      },
    ],
    nameAr: 'Tiime',
    taglineAr: 'نموذج ممول ذاتياً - فوترة مجانية تحولت لتقنية مالية',
    descriptionAr: 'Tiime فوترة SaaS ممولة ذاتياً (فوترة مجانية للشركات) توسعت لخدمات مالية - مدخل مجاني لمنتجات مالية دون VC.',
    stepsAr: [
      {
        title: 'ادرس المنتج',
        description: 'استكشف tiime.fr: فوترة مجانية كمدخل مع طبقات مالية مدفوعة.',
        url: 'https://www.tiime.fr/',
      },
      {
        title: 'انسخ درس التمويل الذاتي',
        description: 'منتج مدخل مجاني يستقطب الشركات رخيصاً؛ حقق الدخل بالخدمات المالية.',
      },
      {
        title: 'طبّق في شركتك',
        description: 'امنح المدخل مجاناً وتقاضَ مقابل القيمة المالية.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
