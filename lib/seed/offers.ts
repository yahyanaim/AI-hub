...
- Pro: $249.99/شهر ($199.99/شهر سنوي), 125,000 رصيد/شهر، 1 تيرابايت`,
  ...
  },
  {
    ...
    tagline: 'FREE coding models inside Cline - incl. GLM + DeepSeek V4 Flash, limited time',
    description: `Cline gives every free account a rotating quota of FREE coding models - including GLM (z-ai/glm-5) and DeepSeek V4 Flash, which works even at $0 balance. Look for the FREE tag in the model picker, code without paying, and switch to ClinePass ($9.99/mo) or pay-as-you-go when your quota runs out. Free models work in the IDE extension and CLI only, not via API.`,
    url: 'https://cline.bot',
    logoUrl: 'https://icons.duckduckgo.com/ip3/cline.bot.ico',
    category: 'api-access',
    tags: ['cline', 'free', 'coding', 'ai-agent', 'models', 'api', 'glm', 'deepseek'],
    pricing: 'free',
    steps: [
      {
        title: 'Install Cline and create a free account',
        description: 'Install Cline from the VS Code marketplace (or JetBrains) or via npm i -g cline for the CLI. Open Cline and sign up for a free Cline account at https://cline.bot - free models require an account.',
        url: 'https://cline.bot',
      },
      {
        title: 'Set the provider to Cline',
        description: 'IDE extension: click the settings icon in the Cline panel and set API Provider to Cline (usage-billing). CLI: run /settings and select Cline as your provider.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'Pick a model tagged FREE',
        description: 'In the model selector, look for models tagged FREE - the lineup rotates, so the exact models change over time. Free quota is limited per promotion.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'Get GLM for free (z-ai/glm-5)',
        description: 'Yes - GLM is free on Cline. Use model ID z-ai/glm-5 (128K context), officially listed under Free Models. It works with the same API interface as paid models.',
      },
      {
        title: 'Get DeepSeek for free (V4 Flash)',
        description: 'Yes - DeepSeek V4 Flash (deepseek/deepseek-v4-flash, 1M context) returns 200 OK even at $0 balance, no card needed. Pick it from the model list for fast edit-test loops, fixes, and routine maintenance.',
      },
      {
        title: 'Start coding - and know what comes after quota',
        description: 'Start coding with the free model before the promotion disappears. When quota runs out: ClinePass ($9.99/mo, 2-5x rate limits on open coding models), pay-as-you-go Cline credits across 100+ models, or bring your own API key. Note: free usage may be used to improve models, and free models do not work through the Cline API.',
      },
    ],
    nameAr: 'نماذج Cline المجانية',
    taglineAr: 'نماذج برمجة مجانية داخل Cline - منها GLM وDeepSeek V4 Flash، لفترة محدودة',
    descriptionAr: `Cline يمنح كل حساب مجاني حصة متجددة من نماذج البرمجة المجانية - منها GLM (z-ai/glm-5) وDeepSeek V4 Flash الذي يعمل حتى برصيد 0$. ابحث عن شارة FREE في قائمة النماذج، وبرمج بدون دفع، ثم انتقل إلى ClinePass (9.99$/شهر) أو الدفع حسب الاستخدام عند انتهاء حصتك. النماذج المجانية تعمل في الإضافة وCLI فقط وليس عبر API.`,
    stepsAr: [
      {
        title: 'ثبّت Cline وأنشئ حساباً مجانياً',
        description: 'ثبّت Cline من متجر VS Code (أو JetBrains) أو عبر npm i -g cline لسطر الأوامر. افتح Cline وسجّل حساباً مجانياً في https://cline.bot - النماذج المجانية تتطلب حساباً.',
        url: 'https://cline.bot',
      },
      {
        title: 'اختر مزود Cline',
        description: 'في الإضافة: اضغط أيقونة الإعدادات واختر API Provider = Cline. في CLI: نفّذ /settings واختر Cline.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'اختر نموذجاً بشارة FREE',
        description: 'في قائمة النماذج ابحث عن النماذج الموسومة FREE - القائمة تتغير دورياً والحصة محدودة.',
        url: 'https://docs.cline.bot/getting-started/free-models',
      },
      {
        title: 'احصل على GLM مجاناً (z-ai/glm-5)',
        description: 'نعم - GLM مجاني في Cline. استخدم المعرف z-ai/glm-5 (سياق 128K) وهو مدرج رسمياً ضمن النماذج المجانية.',
      },
      {
        title: 'احصل على DeepSeek مجاناً (V4 Flash)',
        description: 'نعم - DeepSeek V4 Flash (deepseek/deepseek-v4-flash بسياق 1M) يعمل حتى برصيد 0$ بدون بطاقة. اختره للإصلاحات السريعة والمهام الروتينية.',
      },
      {
        title: 'ابدأ البرمجة - واعرف ما بعد الحصة',
        description: 'ابدأ البرمجة بالنموذج المجاني قبل انتهاء العرض. بعد نفاد الحصة: ClinePass (9.99$/شهر) أو الدفع حسب الاستخدام لأكثر من 100 نموذج أو مفتاح API خاص بك. ملاحظة: الاستخدام المجاني قد يُستخدم لتحسين النماذج، ولا يعمل عبر Cline API.',
      },
    ],
    upvotes: 0,
    bookmarks: 0,
