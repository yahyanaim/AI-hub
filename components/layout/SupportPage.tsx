...
function CopyRow({
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex w-full items-center justify-between gap-2 rounded-lg border border-border bg-muted/40 px-4 py-2.5 text-left transition-colors hover:bg-muted"
    >
    ...
    <div className="container-page flex h-[calc(100dvh-4rem)] items-center overflow-hidden py-6">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="text-center">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-brand-orange/10">
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2">
          ...
          <div className="flex flex-col rounded-2xl border border-border bg-card p-6 shadow-sm">
            <div className="mb-1.5 flex items-center gap-2 text-base font-semibold uppercase tracking-wide text-muted-foreground">
