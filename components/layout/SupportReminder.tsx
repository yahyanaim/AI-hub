...
export function SupportReminder() {
  ...
  return (
    <div className="relative mt-14 overflow-hidden rounded-xl border border-brand-orange/60 bg-card bg-gradient-to-br from-brand-orange/[0.07] via-transparent to-brand-orange/[0.05] px-6 py-10 text-center transition-all duration-200 hover:border-accent hover:shadow-[0_0_24px_var(--accent-glow)]">
      {/* Floating icons */}
